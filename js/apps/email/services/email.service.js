...
function createDefaultEmails() {
    ...
    const defaultEmails = [
        ...
        {from: 'eyal' ,subject: 'EIZE ABALE', body: 'just some text to test', isRead: false, sentAt : 1592994373656},
        {from: 'eyal' ,subject: 'Sprint 3 SUSIM', body: 'just some text to test', isRead: false, sentAt : 1592994373656},
        {from: 'eyal' ,subject: 'Hi there!', body: 'just some text to test', isRead: false, sentAt : 1592994373656},
        {from: 'eyal' ,subject: 'You are FIRED!', body: 'just some text to test', isRead: false, sentAt : 1592994373656},
